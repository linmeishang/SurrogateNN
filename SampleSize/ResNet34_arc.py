# This file defines the Train_ResNet34 function
#%%
...
def ResNet34(input_shape, classes):
    ...
    filters_stage_2 = [8, 8]
    filters_stage_3 = [2*8, 2*8]
    filters_stage_4 = [4*8, 4*8]
    filters_stage_5 = [8*8, 8*8]
...
def Train_ResNet34(X_train, Y_train, m, lr, optimizer, n_epoch, model_name, seed):
