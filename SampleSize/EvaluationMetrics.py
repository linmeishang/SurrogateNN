...
def EvaluationMetrics(Y_test, X_test_raw, Y_test_raw, yhat_test, yhat_test_raw):
    ...
    # N applied and N leaching in true data
    ...
    # N applied and N leaching  in predicted data
    x = X_test_raw['nMin_Quant__mean'] 
    ...
    APE1 = abs(mic_true - mic_pred)/abs(mic_true)
    print("APE1:", APE1)
    print(type(APE1))
    
    # 2) sugarbeet price and relative revenue
    # Crop price and relative revenue in true data
    x = X_test_raw['Sugarbeet_Price_conv_bla']
    y = Y_test_raw['Sugarbeet_SReve__mean']/Y_test_raw['SalesRevenue_sum__mean']
    ...
    # Now calculate for the predicted data
    # Crop price and relative revenue in predicted data
    y = yhat_test_raw['Sugarbeet_SReve__mean']/yhat_test_raw['SalesRevenue_sum__mean']
    ...
    # Calcultae the abselute percentage error (APE)
    APE2 = abs(mic_true - mic_pred)/abs(mic_true)
    print("APE2:", APE2)
