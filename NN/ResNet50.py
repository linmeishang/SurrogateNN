# This is the code of training a ResNet50
#%%
...
f = 32
filters_stage_2 = [f, f, 4*f]
filters_stage_3 = [2*f, 2*f, 8*f]
filters_stage_4 = [4*f, 4*f, 16*f]
filters_stage_5 = [8*f, 8*f, 32*f]

#%%
# set a new working directory and save the model and all related results
model_path = path+"ResNet50"+ datetime.now().strftime("_%Y%m%d%H") 
