# This is the code of training a ResNet18
#%%
...
import time
tf.random.set_seed(120) # specify a random seed for reproducibility
import tensorflow as tf
...
model_path = path+"ResNet18"+ datetime.now().strftime("_%Y%m%d%H") 
